 ...
 *
 * Delegates tab rendering and POST handling to Admin_Tab subclasses.
 */
class Admin
{
	...
	{
		$tab_classes = [
			'\SentinelMCP\Admin_Tab_GetStarted',
			'\SentinelMCP\Admin_Tab_Status',
			'\SentinelMCP\Admin_Tab_Providers',
			'\SentinelMCP\Admin_Tab_Connect',
			'\SentinelMCP\Admin_Tab_Prompts',
			'\SentinelMCP\Admin_Tab_Settings',
			'\SentinelMCP\Admin_Tab_OAuth',
			'\SentinelMCP\Admin_Tab_Activity',
			'\SentinelMCP\Admin_Tab_Info',
		];
	...
	public function add_menu(): void
	{
		...
		add_submenu_page(
			...
			'manage_options',
			'sentinel-chat',
			['SentinelMCP\Admin_Chat', 'render_page']
		);
	}
