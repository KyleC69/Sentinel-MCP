...
class OAuth_Server
{
	...
	public static function register_routes(): void
	{
		...
		register_rest_route(
			...
			array(
				array(
					...
					'callback'            => array('OAuth_Authorize', 'handle_get'),
					'permission_callback' => '__return_true', // Login enforced in callback.
				),
				array(
					'methods'             => \WP_REST_Server::CREATABLE,
					'callback'            => array('OAuth_Authorize', 'handle_post'),
		...
		register_rest_route(
			...
			array(
				'methods'             => \WP_REST_Server::CREATABLE,
				'callback'            => array('OAuth_Token', 'handle'),
		...
		register_rest_route(
			...
			array(
				'methods'             => \WP_REST_Server::CREATABLE,
				'callback'            => array('OAuth_Token', 'handle_revoke'),
