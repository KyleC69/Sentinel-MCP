		...
		private function render_tab_status(): void {
			...
			<div class="card" style="max-width:700px;margin-bottom:20px;padding:15px;">
				...
				<?php if ( $has_mcp ) : ?>
					...
					<code style="font-size:13px;"><?php echo esc_html( rest_url( 'mcp/mcp-adapter-default-server' ) ); ?></code></p>
				<?php else : ?>
				...
				<table class="widefat striped">
					...
					<tbody>
						<?php if ( empty( $result['items'] ) ) : ?>
							<tr><td colspan="8" style="text-align:center;padding:20px;">No entries.</td></tr>
						<?php else : ?>
			...
			<?php if ( function_exists( 'wp_get_abilities' ) && function_exists( 'wp_get_ability_categories' ) ) : ?>
				...
				<div class="card" style="max-width:700px;padding:15px;">
					...
					<table class="widefat striped">
						...
						<?php endforeach; ?>
						<?php if ( ! empty( $no_cat ) ) : ?>
							<tr><td colspan="2" style="background:#f0f0f1;font-weight:bold;">Other</td></tr>
